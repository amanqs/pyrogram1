...
class Meta(type, metaclass=type("", (type,), {"__str__": lambda _: "~hi"})):
    def __str__(self):
        return f"<class 'pyrogram1.types.{self.__name__}'>"


class Object(metaclass=Meta):
    def __init__(self, client: "pyrogram1.Client" = None):
        self._client = client

    def bind(self, client: "pyrogram1.Client"):
        """Bind a Client instance to this Pyrogram1 Object

        Parameters:
            client (:obj:`~pyrogram1.types.Client`):
                The Client instance to bind this object with. Useful to re-enable bound methods after serializing and
                deserializing Pyrogram1 objects with ``repr`` and ``eval``.
        """
        self._client = client
    ...
    def default(obj: "Object"):
        ...
        # https://t.me/pyrogram1chat/167281
