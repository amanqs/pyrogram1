...
from pyrogram1.errors import AuthBytesInvalid
from pyrogram1.session import Session
from pyrogram1.session.auth import Auth


async def get_session(client: "pyrogram1.Client", dc_id: int):
