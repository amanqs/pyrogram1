...
class SentCode(Object):
    ...
    Parameters:
        ...
        phone_code_hash (``str``):
            ...
            :meth:`~pyrogram1.Client.sign_in` or :meth:`~pyrogram1.Client.sign_up`).

        next_type (``str``):
            Type of the next code to be sent with :meth:`~pyrogram1.Client.resend_code`.
        ...
        timeout (``int``):
            Delay in seconds before calling :meth:`~pyrogram1.Client.resend_code`.
    """
