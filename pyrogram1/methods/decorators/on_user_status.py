...
class OnUserStatus(Scaffold):
    def on_user_status(
        ...
        :obj:`~pyrogram1.handlers.UserStatusHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, pyrogram1.Client):
                self.add_handler(pyrogram1.handlers.UserStatusHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        pyrogram1.handlers.UserStatusHandler(func, self),
