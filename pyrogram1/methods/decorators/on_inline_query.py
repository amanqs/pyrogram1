...
class OnInlineQuery(Scaffold):
    def on_inline_query(
        ...
        :obj:`~pyrogram1.handlers.InlineQueryHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, pyrogram1.Client):
                self.add_handler(pyrogram1.handlers.InlineQueryHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        pyrogram1.handlers.InlineQueryHandler(func, self),
