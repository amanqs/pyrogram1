...
class OnChatMemberUpdated(Scaffold):
    def on_chat_member_updated(
        ...
        :obj:`~pyrogram1.handlers.ChatMemberUpdatedHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, pyrogram1.Client):
                self.add_handler(pyrogram1.handlers.ChatMemberUpdatedHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        pyrogram1.handlers.ChatMemberUpdatedHandler(func, self),
