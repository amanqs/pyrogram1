...
class Restart(Scaffold):
    async def restart(self, block: bool = True):
        ...
        This method will first call :meth:`~pyrogram1.Client.stop` and then :meth:`~pyrogram1.Client.start` in a row in
        ...
        Returns:
            :obj:`~pyrogram1.Client`: The restarted client itself.
