...
class SendVideoNote(Scaffold):
    async def send_video_note(
        ...
        Returns:
            :obj:`~pyrogram1.types.Message` | ``None``: On success, the sent video note message is returned, otherwise,
            in case the upload is deliberately stopped with :meth:`~pyrogram1.Client.stop_transmission`, None is
            returned.
