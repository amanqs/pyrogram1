...
from pyrogram1 import StopTransmission
from pyrogram1 import raw
from pyrogram1 import types
from pyrogram1 import utils
from pyrogram1.errors import FilePartMissing
from pyrogram1.file_id import FileType
...
class SendAudio(Scaffold):
    async def send_audio(
        ...
        For sending voice messages, use the :meth:`~pyrogram1.Client.send_voice` method instead.
        ...
        Returns:
            :obj:`~pyrogram1.types.Message` | ``None``: On success, the sent audio message is returned, otherwise, in
            case the upload is deliberately stopped with :meth:`~pyrogram1.Client.stop_transmission`, None is returned.
