...
from pyrogram1.connection import Connection
from pyrogram1.crypto import aes, rsa, prime
from pyrogram1.errors import SecurityCheckMismatch
from pyrogram1.raw.core import TLObject, Long, Int
...
class Auth:
    ...
    def __init__(self, client: "pyrogram1.Client", dc_id: int, test_mode: bool):
        self.dc_id = dc_id
