...
from pyrogram1 import utils
from pyrogram1.errors import MessageIdsEmpty, PeerIdInvalid
from pyrogram1.parser import utils as parser_utils, Parser
...
class Message(Object, Update):
    ...
    Parameters:
        ...
        from_user (:obj:`~pyrogram1.types.User`, *optional*):
            Sender, empty for messages sent to channels.

        sender_chat (:obj:`~pyrogram1.types.Chat`, *optional*):
        ...
        chat (:obj:`~pyrogram1.types.Chat`, *optional*):
            Conversation the message belongs to.

        forward_from (:obj:`~pyrogram1.types.User`, *optional*):
        ...
        forward_from_chat (:obj:`~pyrogram1.types.Chat`, *optional*):
        ...
        reply_to_message (:obj:`~pyrogram1.types.Message`, *optional*):
        ...
        entities (List of :obj:`~pyrogram1.types.MessageEntity`, *optional*):
            For text messages, special entities like usernames, URLs, bot commands, etc. that appear in the text.

        caption_entities (List of :obj:`~pyrogram1.types.MessageEntity`, *optional*):
            For messages with a caption, special entities like usernames, URLs, bot commands, etc. that appear
            in the caption.

        audio (:obj:`~pyrogram1.types.Audio`, *optional*):
            Message is an audio file, information about the file.

        document (:obj:`~pyrogram1.types.Document`, *optional*):
            Message is a general file, information about the file.

        photo (:obj:`~pyrogram1.types.Photo`, *optional*):
            Message is a photo, information about the photo.

        sticker (:obj:`~pyrogram1.types.Sticker`, *optional*):
            Message is a sticker, information about the sticker.

        animation (:obj:`~pyrogram1.types.Animation`, *optional*):
            Message is an animation, information about the animation.

        game (:obj:`~pyrogram1.types.Game`, *optional*):
            Message is a game, information about the game.

        video (:obj:`~pyrogram1.types.Video`, *optional*):
            Message is a video, information about the video.

        voice (:obj:`~pyrogram1.types.Voice`, *optional*):
            Message is a voice message, information about the file.

        video_note (:obj:`~pyrogram1.types.VideoNote`, *optional*):
        ...
        contact (:obj:`~pyrogram1.types.Contact`, *optional*):
            Message is a shared contact, information about the contact.

        location (:obj:`~pyrogram1.types.Location`, *optional*):
            Message is a shared location, information about the location.

        venue (:obj:`~pyrogram1.types.Venue`, *optional*):
            Message is a venue, information about the venue.

        web_page (:obj:`~pyrogram1.types.WebPage`, *optional*):
            Message was sent with a webpage preview.

        poll (:obj:`~pyrogram1.types.Poll`, *optional*):
            Message is a native poll, information about the poll.

        dice (:obj:`~pyrogram1.types.Dice`, *optional*):
            A dice containing a value that is randomly generated by Telegram.

        new_chat_members (List of :obj:`~pyrogram1.types.User`, *optional*):
            New members that were added to the group or supergroup and information about them
            (the bot itself may be one of these members).

        left_chat_member (:obj:`~pyrogram1.types.User`, *optional*):
            A member was removed from the group, information about them (this member may be the bot itself).

        new_chat_title (``str``, *optional*):
            A chat title was changed to this value.

        new_chat_photo (:obj:`~pyrogram1.types.Photo`, *optional*):
        ...
        pinned_message (:obj:`~pyrogram1.types.Message`, *optional*):
            Specified message was pinned.
            Note that the Message object in this field will not contain further reply_to_message fields even if it
            is itself a reply.

        game_high_score (:obj:`~pyrogram1.types.GameHighScore`, *optional*):
        ...
        via_bot (:obj:`~pyrogram1.types.User`):
        ...
        matches (List of regex Matches, *optional*):
            ...
            the text of this message. Only applicable when using :obj:`Filters.regex <pyrogram1.Filters.regex>`.

        command (List of ``str``, *optional*):
            A list containing the command and its arguments, if any.
            E.g.: "/start 1 2 3" would produce ["start", "1", "2", "3"].
            Only applicable when using :obj:`~pyrogram1.filters.command`.

        voice_chat_scheduled (:obj:`~pyrogram1.types.VoiceChatScheduled`, *optional*):
            Service message: voice chat scheduled.

        voice_chat_started (:obj:`~pyrogram1.types.VoiceChatStarted`, *optional*):
            Service message: the voice chat started.

        voice_chat_ended (:obj:`~pyrogram1.types.VoiceChatEnded`, *optional*):
            Service message: the voice chat has ended.

        voice_chat_members_invited (:obj:`~pyrogram1.types.VoiceChatParticipantsInvited`, *optional*):
            Service message: new members were invited to the voice chat.

        reply_markup (:obj:`~pyrogram1.types.InlineKeyboardMarkup` | :obj:`~pyrogram1.types.ReplyKeyboardMarkup` | :obj:`~pyrogram1.types.ReplyKeyboardRemove` | :obj:`~pyrogram1.types.ForceReply`, *optional*):
            Additional interface options. An object for an inline keyboard, custom reply keyboard,
            instructions to remove reply keyboard or to force a reply from the user.

        reactions (List of :obj:`~pyrogram1.types.Reaction`):
    ...
    async def get_media_group(self) -> List["types.Message"]:
        """Bound method *get_media_group* of :obj:`~pyrogram1.types.Message`.
        ...
        Returns:
            List of :obj:`~pyrogram1.types.Message`: On success, a list of messages of the media group is returned.
    ...
    async def reply_text(
        ...
        """Bound method *reply_text* of :obj:`~pyrogram1.types.Message`.
    ...
    async def reply_animation(
        ...
        """Bound method *reply_animation* :obj:`~pyrogram1.types.Message`.
        ...
        Returns:
            On success, the sent :obj:`~pyrogram1.types.Message` is returned.
            In case the upload is deliberately stopped with :meth:`~pyrogram1.Client.stop_transmission`, None is returned
            instead.
    ...
    async def reply_audio(
        ...
        """Bound method *reply_audio* of :obj:`~pyrogram1.types.Message`.
    ...
    async def reply_cached_media(
        ...
        """Bound method *reply_cached_media* of :obj:`~pyrogram1.types.Message`.
    ...
    async def reply_chat_action(self, action: str) -> bool:
        """Bound method *reply_chat_action* of :obj:`~pyrogram1.types.Message`.
    ...
    async def reply_contact(
        ...
        """Bound method *reply_contact* of :obj:`~pyrogram1.types.Message`.
    ...
    async def reply_document(
        ...
        """Bound method *reply_document* of :obj:`~pyrogram1.types.Message`.
    ...
    async def reply_game(
        ...
        """Bound method *reply_game* of :obj:`~pyrogram1.types.Message`.
    ...
    async def reply_inline_bot_result(
        ...
        """Bound method *reply_inline_bot_result* of :obj:`~pyrogram1.types.Message`.
    ...
    async def reply_location(
        ...
        """Bound method *reply_location* of :obj:`~pyrogram1.types.Message`.
    ...
    async def reply_media_group(
        ...
        """Bound method *reply_media_group* of :obj:`~pyrogram1.types.Message`.
        ...
        Parameters:
            media (``list``):
                A list containing either :obj:`~pyrogram1.types.InputMediaPhoto` or
                :obj:`~pyrogram1.types.InputMediaVideo` objects
        ...
        Returns:
            On success, a :obj:`~pyrogram1.types.Messages` object is returned containing all the
    ...
    async def reply_photo(
        ...
        """Bound method *reply_photo* of :obj:`~pyrogram1.types.Message`.
    ...
    async def reply_poll(
        ...
        """Bound method *reply_poll* of :obj:`~pyrogram1.types.Message`.
        ...
        .. code-block:: python
            ...
            client.send_poll(
                chat_id=message.chat.id,
                question="Is Pyrogram1 the best?",
                options=["Yes", "Yes"]
            )
        ...
        Example:
            .. code-block:: python
                ...
                message.reply_poll("Is Pyrogram1 the best?", ["Yes", "Yes"])
    ...
    async def reply_sticker(
        ...
        """Bound method *reply_sticker* of :obj:`~pyrogram1.types.Message`.
    ...
    async def reply_venue(
        ...
        """Bound method *reply_venue* of :obj:`~pyrogram1.types.Message`.
    ...
    async def reply_video(
        ...
        """Bound method *reply_video* of :obj:`~pyrogram1.types.Message`.
    ...
    async def reply_video_note(
        ...
        """Bound method *reply_video_note* of :obj:`~pyrogram1.types.Message`.
    ...
    async def reply_voice(
        ...
        """Bound method *reply_voice* of :obj:`~pyrogram1.types.Message`.
    ...
    async def edit_text(
        ...
        """Bound method *edit_text* of :obj:`~pyrogram1.types.Message`.
        ...
        Returns:
            On success, the edited :obj:`~pyrogram1.types.Message` is returned.
    ...
    async def edit_caption(
        ...
        """Bound method *edit_caption* of :obj:`~pyrogram1.types.Message`.
    ...
    async def edit_media(
        ...
        """Bound method *edit_media* of :obj:`~pyrogram1.types.Message`.
        ...
        Parameters:
            media (:obj:`~pyrogram1.types.InputMedia`):
    ...
    async def edit_reply_markup(self, reply_markup: "types.InlineKeyboardMarkup" = None) -> "Message":
        """Bound method *edit_reply_markup* of :obj:`~pyrogram1.types.Message`.
        ...
        Parameters:
            reply_markup (:obj:`~pyrogram1.types.InlineKeyboardMarkup`):
                An InlineKeyboardMarkup object.

        Returns:
            On success, if edited message is sent by the bot, the edited
            :obj:`~pyrogram1.types.Message` is returned, otherwise True is returned.
    ...
    async def forward(
        ...
        """Bound method *forward* of :obj:`~pyrogram1.types.Message`.
    ...
    async def copy(
        ...
        """Bound method *copy* of :obj:`~pyrogram1.types.Message`.
        ...
        Returns:
            :obj:`~pyrogram1.types.Message`: On success, the copied message is returned.
    ...
    async def delete(self, revoke: bool = True):
        """Bound method *delete* of :obj:`~pyrogram1.types.Message`.
    ...
    async def click(self, x: Union[int, str] = 0, y: int = None, quote: bool = None, timeout: int = 10):
        """Bound method *click* of :obj:`~pyrogram1.types.Message`.
        ...
        Returns:
            -   The result of :meth:`~pyrogram1.Client.request_callback_answer` in case of inline callback button clicks.
    ...
    async def react(self, emoji: str = "") -> bool:
        """Bound method *react* of :obj:`~pyrogram1.types.Message`.
    ...
    async def retract_vote(
        ...
        """Bound method *retract_vote* of :obj:`~pyrogram1.types.Message`.
        ...
        Returns:
            :obj:`~pyrogram1.types.Poll`: On success, the poll with the retracted vote is returned.
    ...
    async def download(
        ...
        """Bound method *download* of :obj:`~pyrogram1.types.Message`.
    ...
    async def vote(
        ...
        """Bound method *vote* of :obj:`~pyrogram1.types.Message`.
        ...
        Returns:
            :obj:`~pyrogram1.types.Poll`: On success, the poll with the chosen option is returned.
    ...
    async def pin(self, disable_notification: bool = False, both_sides: bool = False) -> "types.Message":
        """Bound method *pin* of :obj:`~pyrogram1.types.Message`.
        ...
        Returns:
            :obj:`~pyrogram1.types.Message`: On success, the service message is returned.
    ...
    async def unpin(self) -> bool:
        """Bound method *unpin* of :obj:`~pyrogram1.types.Message`.
