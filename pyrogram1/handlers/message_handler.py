...
class MessageHandler(Handler):
    ...
    any chat (private, group, channel). It is intended to be used with :meth:`~pyrogram1.Client.add_handler`

    For a nicer way to register this handler, have a look at the
    :meth:`~pyrogram1.Client.on_message` decorator.
    ...
    Other parameters:
        ...
        message (:obj:`~pyrogram1.types.Message`):
