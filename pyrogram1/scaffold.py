...
import pyrogram1
from pyrogram1 import __version__
from pyrogram1.parser import Parser
from pyrogram1.session.internals import MsgId
from .mime_types import mime_types


class Scaffold:
    APP_VERSION = f"Pyrogram1 {__version__}"
    ...
    def __init__(self):
        try:
            ...
            asyncio.set_event_loop(pyrogram1.main_event_loop)
