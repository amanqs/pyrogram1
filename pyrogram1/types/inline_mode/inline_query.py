...
class InlineQuery(Object, Update):
    ...
    Parameters:
        ...
        matches (List of regex Matches, *optional*):
            ...
            the query of this inline query. Only applicable when using :obj:`Filters.regex <pyrogram1.Filters.regex>`.
    """
    ...
    async def answer(
        ...
        """Bound method *answer* of :obj:`~pyrogram1.types.InlineQuery`.
        ...
        Parameters:
            results (List of :obj:`~pyrogram1.types.InlineQueryResult`):
