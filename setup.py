...
with open("pyrogram1/__init__.py", encoding="utf-8") as f:
...
class Clean(Command):
    DIST = ["./build", "./dist", "./Pyrogram1.egg-info"]
    API = [
        "pyrogram1/errors/exceptions", "pyrogram1/raw/functions", "pyrogram1/raw/types", "pyrogram1/raw/base",
        "pyrogram1/raw/all.py"
    ]
    DOCS = [
...
class Generate(Command):
    description = "Generate Pyrogram1 files"
...
setup(
    ...
    url="https://github.com/pyrogram1",
    download_url="https://github.com/pyrogram1/pyrogram1/releases/latest",
    author="Dan",
    author_email="dan@pyrogram1.org",
    license="LGPLv3+",
    classifiers=[
    ...
    project_urls={
        "Tracker": "https://github.com/pyrogram1/pyrogram1/issues",
        "Community": "https://t.me/pyrogram1",
        "Source": "https://github.com/pyrogram1/pyrogram1",
        "Documentation": "https://docs.pyrogram1.org",
    },
    python_requires="~=3.6",
    package_data = {
        "pyrogram1": ["py.typed"],
