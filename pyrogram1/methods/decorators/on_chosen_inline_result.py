...
class OnChosenInlineResult(Scaffold):
    def on_chosen_inline_result(
        ...
        :obj:`~pyrogram1.handlers.ChosenInlineResultHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, pyrogram1.Client):
                self.add_handler(pyrogram1.handlers.ChosenInlineResultHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        pyrogram1.handlers.ChosenInlineResultHandler(func, self),
