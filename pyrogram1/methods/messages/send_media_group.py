...
class SendMediaGroup(Scaffold):
    ...
    async def send_media_group(
        ...
        Parameters:
            ...
            media (List of :obj:`~pyrogram1.types.InputMediaPhoto`, :obj:`~pyrogram1.types.InputMediaVideo`, :obj:`~pyrogram1.types.InputMediaAudio` and :obj:`~pyrogram1.types.InputMediaDocument`):
        ...
        Returns:
            List of :obj:`~pyrogram1.types.Message`: On success, a list of the sent messages is returned.

        Example:
            .. code-block:: python

                from pyrogram1.types import InputMediaPhoto, InputMediaVideo
