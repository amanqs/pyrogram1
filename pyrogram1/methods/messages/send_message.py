...
from pyrogram1 import raw, utils
...
class SendMessage(Scaffold):
    async def send_message(
        ...
        Returns:
            :obj:`~pyrogram1.types.Message`: On success, the sent text message is returned.

        Example:
            .. code-block:: python

                # Simple example
                app.send_message("me", "Message sent with **Pyrogram1**!")

                # Disable web page previews
                app.send_message("me", "https://docs.pyrogram1.org", disable_web_page_preview=True)
                ...
                app.send_message(
                    ...
                    reply_markup=InlineKeyboardMarkup(
                        [
                            ...
                            [InlineKeyboardButton("Docs", url="https://docs.pyrogram1.org")]
                        ]))
        """
