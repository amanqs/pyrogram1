...
import pyrogram1
from pyrogram1 import __version__, __license__
from pyrogram1 import raw
from pyrogram1 import utils
from pyrogram1.crypto import aes
from pyrogram1.errors import CDNFileHashMismatch
from pyrogram1.errors import (
    SessionPasswordNeeded,
    VolumeLocNotFound, ChannelPrivate,
    AuthBytesInvalid, BadRequest
)
from pyrogram1.handlers.handler import Handler
from pyrogram1.methods import Methods
from pyrogram1.session import Auth, Session
from pyrogram1.storage import Storage, FileStorage, MemoryStorage
from pyrogram1.types import User, TermsOfService
from pyrogram1.utils import ainput
...
class Client(Methods, Scaffold):
    """Pyrogram1 Client, the main means for interacting with Telegram.
    ...
    Parameters:
        session_name (``str``):
            ...
            :meth:`~pyrogram1.Client.export_session_string` before stopping the client to get a session string you can
        ...
        app_version (``str``, *optional*):
            Application version. Defaults to "Pyrogram1 |version|".
            This is an alternative way to set it if you don't want to use the *config.ini* file.
        ...
        workdir (``str``, *optional*):
            Define a custom working directory. The working directory is the location in your filesystem where Pyrogram1
    ...
    async def authorize(self) -> User:
        ...
        print(f"Welcome to Pyrogram1 (version {__version__})")
        print(f"Pyrogram1 is free software and comes with ABSOLUTELY NO WARRANTY. Licensed\n"
    ...
    def load_config(self):
        ...
        if self.bot_token:
            ...
            self.bot_token = parser.get("pyrogram1", "bot_token", fallback=None)

        if self.api_id and self.api_hash:
            pass
        else:
            if parser.has_section("pyrogram1"):
                self.api_id = parser.getint("pyrogram1", "api_id")
                self.api_hash = parser.get("pyrogram1", "api_hash")
            else:
                raise AttributeError("No API Key found. More info: https://docs.pyrogram1.org/intro/setup")
    ...
    async def get_file(
        ...
        try:
            ...
            if not isinstance(e, pyrogram1.StopTransmission):
                log.error(e, exc_info=True)
