...
class GetChat(Scaffold):
    async def get_chat(
        ...
        Returns:
            :obj:`~pyrogram1.types.Chat` | :obj:`~pyrogram1.types.ChatPreview`: On success, if you've already joined the chat, a chat object is returned,
