...
async def idle():
    ...
    The way Pyrogram1 works, it will keep your handlers in a pool of worker threads, which are executed concurrently
    ...
    Don't forget to call :meth:`~pyrogram1.Client.stop` for each running client before the script ends.
