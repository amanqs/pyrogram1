...
class SendInlineBotResult(Scaffold):
    async def send_inline_bot_result(
        ...
        Bot results can be retrieved using :meth:`~pyrogram1.Client.get_inline_bot_results`
        ...
        Returns:
            :obj:`~pyrogram1.types.Message`: On success, the sent inline result message is returned.
