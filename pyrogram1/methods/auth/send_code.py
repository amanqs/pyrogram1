...
from pyrogram1.errors import PhoneMigrate, NetworkMigrate
from pyrogram1.scaffold import Scaffold
from pyrogram1.session import Session, Auth
...
class SendCode(Scaffold):
    async def send_code(self, phone_number: str) -> "types.SentCode":
        ...
        Returns:
            :obj:`~pyrogram1.types.SentCode`: On success, an object containing information on the sent confirmation code
            is returned.
