...
class OnChatJoinRequest(Scaffold):
    def on_chat_join_request(
        ...
        :obj:`~pyrogram1.handlers.ChatJoinRequestHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, pyrogram1.Client):
                self.add_handler(pyrogram1.handlers.ChatJoinRequestHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        pyrogram1.handlers.ChatJoinRequestHandler(func, self),
