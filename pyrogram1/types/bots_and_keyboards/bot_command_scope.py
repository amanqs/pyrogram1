...
class BotCommandScope(Object):
    ...
    - :obj:`~pyrogram1.types.BotCommandScopeDefault`
    - :obj:`~pyrogram1.types.BotCommandScopeAllPrivateChats`
    - :obj:`~pyrogram1.types.BotCommandScopeAllGroupChats`
    - :obj:`~pyrogram1.types.BotCommandScopeAllChatAdministrators`
    - :obj:`~pyrogram1.types.BotCommandScopeChat`
    - :obj:`~pyrogram1.types.BotCommandScopeChatAdministrators`
    - :obj:`~pyrogram1.types.BotCommandScopeChatMember`
