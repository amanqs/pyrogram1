...
class OnDeletedMessages(Scaffold):
    def on_deleted_messages(
        ...
        :obj:`~pyrogram1.handlers.DeletedMessagesHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, pyrogram1.Client):
                self.add_handler(pyrogram1.handlers.DeletedMessagesHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        pyrogram1.handlers.DeletedMessagesHandler(func, self),
