...
class IterProfilePhotos(Scaffold):
    async def iter_profile_photos(
        ...
        This convenience method does the same as repeatedly calling :meth:`~pyrogram1.Client.get_profile_photos` in a
        ...
        Returns:
            ``Generator``: A generator yielding :obj:`~pyrogram1.types.Photo` objects.
