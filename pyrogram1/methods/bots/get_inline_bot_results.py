...
from pyrogram1.errors import UnknownError
...
class GetInlineBotResults(Scaffold):
    async def get_inline_bot_results(
        ...
        You can then send a result using :meth:`~pyrogram1.Client.send_inline_bot_result`
        ...
        Returns:
            :obj:`BotResults <pyrogram1.api.types.messages.BotResults>`: On Success.
        ...
        Example:
            .. code-block:: python
                ...
                results = app.get_inline_bot_results("pyrogram1bot")
                print(results)
        """
