...
from pyrogram1.methods.utilities.idle import idle
...
class Run(Scaffold):
    def run(self, coroutine=None):
        ...
        This is a convenience method that calls :meth:`~pyrogram1.Client.start`, :meth:`~pyrogram1.idle` and
        :meth:`~pyrogram1.Client.stop` in sequence. It makes running a single client less verbose.
